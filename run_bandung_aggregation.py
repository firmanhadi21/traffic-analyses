#!/usr/bin/env python3
"""
Bandung Traffic Data Aggregation - Full Date Range
Aggregates all traffic data from traffic_data_bdg folder by time period
"""
...
def analyze_bandung_traffic(city_folder, traffic_column, output_folder):
    """
    Analyze Bandung traffic patterns and save GPKG files for each time period
    """
    ...
    for i, file in enumerate(gpkg_files):
        ...
        if df is not None:
            ...
            if timestamp:
                ...
                # Keep only fid and traffic column
    ...
    print("\n" + "="*60)
    print("BANDUNG AGGREGATION COMPLETE!")
    print("="*60)

if __name__ == "__main__":
    city_folder = "traffic_data_bdg"
    traffic_column = "jam_factor"
    output_folder = "traffic_bdg_output"

    analyze_bandung_traffic(city_folder, traffic_column, output_folder)
